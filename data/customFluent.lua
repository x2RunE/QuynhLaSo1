...
local aa = {
	...
	[54] = function()
		...
		return {
			...
			Tab = Color3.fromRGB(245, 245, 230),
			Element = Color3.fromRGB(255, 255, 255),
			ElementBorder = Color3.fromRGB(225, 225, 225),
			InElementBorder = Color3.fromRGB(210, 210, 210),
			ElementTransparency = 0.4,
			ToggleSlider = Color3.fromRGB(230, 230, 200),
			ToggleToggled = Color3.fromRGB(255, 219, 120),
			SliderRail = Color3.fromRGB(230, 230, 230),
			DropdownFrame = Color3.fromRGB(255, 255, 255),
			DropdownHolder = Color3.fromRGB(250, 250, 235),
			DropdownBorder = Color3.fromRGB(220, 220, 200),
			DropdownOption = Color3.fromRGB(230, 210, 150),
			Keybind = Color3.fromRGB(240, 240, 230),
			Input = Color3.fromRGB(255, 255, 245),
			InputFocused = Color3.fromRGB(255, 230, 160),
			InputIndicator = Color3.fromRGB(255, 214, 100),
			Dialog = Color3.fromRGB(255, 255, 255),
			DialogHolder = Color3.fromRGB(250, 250, 235),
			DialogHolderLine = Color3.fromRGB(235, 235, 220),
			DialogButton = Color3.fromRGB(255, 255, 255),
			DialogButtonBorder = Color3.fromRGB(230, 230, 200),
			DialogBorder = Color3.fromRGB(210, 210, 190),
			DialogInput = Color3.fromRGB(255, 255, 245),
			DialogInputLine = Color3.fromRGB(220, 220, 180),
			Text = Color3.fromRGB(0, 0, 0),
